...
export default async function DashboardPage() {
  ...
  return <><PageHeading eyebrow="Overview" title="Dashboard" description="Today’s shop activity and production workload, shown for your role." />
    ...
    <div className="mt-5 grid items-start gap-5 xl:grid-cols-[1.3fr_.7fr]">
      {data.canViewFinancials ? <Card className="p-6"><div className="mb-5"><h2 className="text-lg font-black text-slate-900">Monthly sales</h2><p className="text-sm text-slate-500">Finalized invoice totals for the current calendar year.</p></div><MonthlySalesChart data={data.monthly} /></Card> : null}
