...
function fixture(): BackupData {
  ...
  data.users = [{ id: "user-1", name: "Admin", email: "admin@example.com", role: "ADMIN", status: "ACTIVE", createdAt: "2026-09-12T00:00:00.000Z", updatedAt: "2026-09-12T00:00:00.000Z" }];
