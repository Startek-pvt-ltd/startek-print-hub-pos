...
describe("order workflow and authorization",()=>{
  ...
  it("restricts cancellation to administrators and managers",()=>{expect(()=>assertOrderTransition("PENDING","CANCELLED","MANAGER")).not.toThrow();expect(()=>assertOrderTransition("PENDING","CANCELLED","CASHIER")).toThrow()});
