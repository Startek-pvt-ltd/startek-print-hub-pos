...
const rolePermissions: Record<Role, ReadonlySet<Permission>> = {
  ...
  MANAGER: new Set([
    "dashboard:view", "pos:use", "orders:view", "orders:update-status",
    "quotations:manage", "expenses:manage", "cash-register:operate",
  ...
  CASHIER: new Set([
    ...
    "orders:view", "quotations:manage", "cash-register:operate", "receipts:reprint",
  ]),
